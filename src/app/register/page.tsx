...
import { Lock, User, Mail, KeyRound, Loader2, ArrowRight } from "lucide-react";
    ...
    <div style={{ 
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        <div style={{ 
          ...
          <h2 style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--text-main)', textAlign: 'center', marginBottom: '0.5rem' }}>Create Account</h2>
          <p style={{ textAlign: 'center', color: 'var(--text-muted)', marginBottom: '2rem' }}>Sign up to start locking your content.</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
            <div>
              <label style={{ display: 'block', marginBottom: '0.5rem', color: 'var(--text-main)', fontWeight: 600, fontSize: '0.95rem' }}>Full Name <span style={{ color: 'var(--text-muted)', fontWeight: 400 }}>(Optional)</span></label>
            ...
            >
              {loading ? <><Loader2 className="animate-spin" size={20} /> Registering...</> : <>Sign Up <ArrowRight size={20} /></>}
            </button>
          </form>
